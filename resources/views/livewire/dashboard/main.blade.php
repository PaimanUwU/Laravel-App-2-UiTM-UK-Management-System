  ...
  <div class="grid grid-cols-1 md:grid-cols-6 lg:grid-cols-12 gap-4 auto-rows-[120px]">
    ...
    <div
      ...
      <div class="relative z-10 h-full flex flex-col justify-between p-5">
        <div>
          <h3 class="text-xl font-bold mb-1 text-white">Quick Actions</h3>
          <p class="text-sm text-gray-400 transition-colors group-hover:text-gray-300">Manage clinic flow & records</p>
        </div>
        <div class="grid grid-cols-2 gap-3">
          <flux:button href="{{ route('appointments.create') }}" variant="primary"
            class="!bg-white !text-zinc-900 border-none hover:!bg-gray-100 font-bold">
            <flux:icon.plus variant="mini" class="w-4 h-4 mr-1" />
            <span>Appt</span>
          </flux:button>
          <flux:button href="{{ route('patients.create') }}" variant="primary"
            class="!bg-zinc-800 !text-white hover:!bg-zinc-700 border-zinc-700 font-bold">
    ...
    <div
      ...
      <div class="p-3 bg-orange-50 rounded-lg text-orange-700">
    ...
    <div
      ...
      <div class="flex items-center gap-3">
        ...
        <div>
          <p class="text-[10px] font-bold text-gray-400 uppercase tracking-wider leading-none mb-1">System Status</p>
    ...
    <div
      ...
      <div class="p-5 pb-4 border-b border-gray-100">
        <div class="flex items-center justify-between">
          ...
          <flux:icon.chevron-right class="w-5 h-5 text-gray-300" />
        </div>
      </div>
          ...
          @foreach($upcomingAppointments as $appointment)
            <div
              ...
              <div class="flex-shrink-0 w-14 h-14 p-1.5 bg-zinc-900 rounded-xl text-white text-center shadow-sm">
                ...
                <p class="text-xl font-black leading-none mt-1">
